...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p>This website at the end of its construction will act as a consumer oriented service for users for easy payment of their respective <b>Energy Bill</b> as well as interact with their providers in case of any queries or grivances.</p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1>Sign Up</h1>
    ...
    <div class="container">
        ...
        <div class="row mt centered">
            <div class="col-lg-4">
                <img src="assets/img/edge.png" width="180" alt="">
                <h4>1 - Login</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->
            ...
            <div class="col-lg-4">
                <img src="assets/img/bill.png" width="180" alt="">
            ...
            <div class="col-lg-4">
                <img src="assets/img/history.png" width="180" alt="">
                <h4>3 - Transact</h4>
                <p></p>
            </div>
            <!--/col-lg-4 -->
